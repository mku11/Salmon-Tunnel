...
copy /Y Salmon.Native.%SALMON_LIB_VERSION%.nupkg Salmon.Native.%SALMON_LIB_VERSION%.zip
powershell -command Expand-Archive -Force Salmon.Native.%SALMON_LIB_VERSION%.zip
